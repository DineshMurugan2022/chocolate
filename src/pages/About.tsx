...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-cocoa-deep selection:bg-burnt-caramel selection:text-white relative overflow-hidden">
      ...
      <SEO 
        title="Our Story & Heritage Registry | British Chocolate Store"
        description="Discover the history and heritage of the British Chocolate Store. From our molecular extraction processes to our curated estate registries."
      />
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-20 items-end relative z-10">
          <div className="space-y-12">
            <div className="flex items-center gap-6">
               ...
               />
               <div className="h-[1px] w-20 bg-burnt-caramel/10" />
               <span className="font-body text-[10px] font-black uppercase tracking-[0.6em] text-burnt-caramel/30">Heritage_Registry_v2</span>
            </div>
            <h1 className="text-5xl md:text-[9vw] font-display font-black leading-[0.8] tracking-tighter text-cocoa-deep">
              British <br /> <span className="italic font-light text-burnt-caramel/20 pr-4">Heritage</span> <span className="text-cocoa-deep">Odyssey</span>
            </h1>

          </div>

          <div className="pb-4 space-y-10 border-l border-burnt-caramel/10 pl-12">
            <p className="font-serif italic text-2xl md:text-3xl text-cocoa-deep/50 leading-relaxed max-w-sm">
              "We do not create flavor; we respectfully harvest it from the molecular depths of our estates."
            </p>
          ...
          >
            ...
            >
              ...
              <div className={`absolute -top-12 ${index % 2 !== 0 ? '-right-12' : '-left-12'} z-20`}>
                <div className="size-40 rounded-full bg-white/60 backdrop-blur-xl border border-gold-soft/10 shadow-2xl flex flex-col items-center justify-center group-hover:bg-burnt-caramel group-hover:text-white transition-all duration-700 overflow-hidden relative">
                  ...
                  <span className="font-body text-[9px] font-black uppercase tracking-[0.5em] mb-2 opacity-30 text-cocoa-deep">BATCH</span>
                  <span className="text-5xl font-display font-black text-cocoa-deep">{ms.year}</span>
                </div>
              </div>
            ...
            >
              <div className="space-y-6">
                ...
                <h2 className="text-4xl md:text-7xl font-display font-black text-cocoa-deep leading-[0.9] tracking-tight">
                  ...
                  Phase <span className="text-cocoa-deep">{ms.year}</span>
                </h2>
              </div>

              <div className="space-y-12">
                <p className="font-serif italic text-2xl md:text-3xl text-cocoa-deep/70 leading-relaxed border-l-4 border-gold-soft/10 pl-10">
                  {ms.content}
                </p>

                <div className="flex items-center gap-8">
                  <button className="h-16 px-10 bg-white/40 border border-gold-soft/10 rounded-2xl flex items-center gap-6 shadow-xl hover:bg-burnt-caramel hover:text-white transition-all transform active:scale-95 group/btn text-cocoa-deep">
                  ...
                  <span className="font-body text-[8px] font-black uppercase tracking-[0.4em] text-cocoa-deep/20">PROTOCOL_SECURED</span>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      >
        <motion.div
          ...
          viewport={{ once: true }}
          className="max-w-6xl mx-auto rounded-[30px] md:rounded-[40px] p-8 md:p-12 text-cocoa-deep relative overflow-hidden shadow-2xl group border border-burnt-caramel/20 bg-gold-soft/10"
          style={{
        ...
        >
          ...
          >
            <h3 className="text-[40vw] font-display font-black text-cocoa-deep italic tracking-tighter">HERITAGE</h3>
          </motion.div>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10 md:gap-20">
            <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-4">
              ...
              <h2 className="text-2xl md:text-4xl font-display font-black tracking-tight leading-tight">
                <span className="italic font-light text-cocoa-deep/30 block text-xs md:text-sm mb-1">Continue the</span>
            ...
            <div className="flex flex-col items-center md:items-end text-center md:text-right space-y-6">
              <p className="text-sm md:text-base font-serif italic max-w-sm text-cocoa-deep/40 leading-relaxed">
                Every creation is a dialogue between tradition and imagination. We invite you to experience the next chapter.
              </p>
              <button
                onClick={() => navigate('/shop')}
                className="h-14 px-10 md:px-12 bg-burnt-caramel text-white rounded-[16px] font-body font-black text-[9px] md:text-[10px] uppercase tracking-[0.4em] hover:bg-cocoa-deep transition-all shadow-xl transform active:scale-95 flex items-center justify-center gap-4 md:gap-6 group"
              >
