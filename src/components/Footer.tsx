        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-8">
            <div className="flex flex-col items-center md:items-start gap-4">
               <Logo className={`w-56 md:w-64 h-auto ${isCelestialTheme ? 'brightness-150 contrast-125' : ''}`} variant="light" />
               <p className={`max-w-xs font-serif italic ${isCelestialTheme ? 'text-aurora-cyan/40' : 'text-ivory-warm/40'} text-[10px] uppercase tracking-[0.4em] mb-4`}>
