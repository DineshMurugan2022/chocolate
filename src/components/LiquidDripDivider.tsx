...
export default function LiquidDripDivider({ 
  ...
  return (
    <div className={`relative w-full h-40 md:h-64 overflow-hidden pointer-events-none ${className} ${flipped ? 'rotate-180 mb-[-1px]' : 'mt-[-1px]'}`}>
      ...
      >
        <motion.path
          d="M0,96L80,128C160,160,320,224,480,213.3C640,203,800,117,960,101.3C1120,85,1280,139,1360,165.3L1440,192L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"
